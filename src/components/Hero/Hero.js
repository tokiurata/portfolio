    ...
    <div className="hero" >
      <div className="hero__copy">
        ...
        <p className="hero__body">
          I'm a natural problem-solver, committed to quality and accessible code. I strongly believe in teamwork and love collaborating with a diverse, multicultural team. I'm currently focusing on <span className="hero__body--span">React</span>, <span className="hero__body--span">Redux</span>, and <span className="hero__body--span">TypeScript</span>.
        </p>
      </div>
    </div>
  );
